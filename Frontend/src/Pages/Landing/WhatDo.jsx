...
<div class="py-10 bg-[#0e1133]">
  ...
  <div class="hero-content flex-col-reverse md:flex-row-reverse items-center">
    ...
    <div class="md:w-7/12">
      ...
      <!-- Feature Card 2 -->
      <div class="card my-5 w-[80%] mx-auto md:card-side p-5 rounded-md border border-[#20993061] hover:border-green-400 bg-transparent">
        <figure>
          <div class="w-4 h-4 bg-green-400 rounded-full"></div>
        </figure>
        <div class="md:pl-5">
          <h2 class="text-lg text-gray-200 font-bold">Well Integrated</h2>
          <p class="text-sm text-gray-500">The bee's knees chancer car boot absolutely.</p>
        </div>
      </div>

      <!-- Feature Card 3 -->
      <div class="card my-5 w-[80%] mx-auto md:card-side p-5 rounded-md border border-[#2eadfc3a] hover:border-[#2eacfc] bg-transparent">
        <figure>
          <div class="w-4 h-4 bg-[#2eacfc] rounded-full"></div>
        </figure>
        <div class="md:pl-5">
          <h2 class="text-lg text-gray-200 font-bold">Clean and modern Design</h2>
          <p class="text-sm text-gray-500">The bee's knees chancer car boot absolutely.</p>
        </div>
      </div>
    </div>
